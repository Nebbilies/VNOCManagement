...
function InfoComponent() {
    ...
    return (
        <div className={"relative flex flex-col max-w-screen h-auto px-4 lg:px-8 mt-40 mb-20 pt-5 pb-10 md:mx-16 lg:mx-32 xl:mx-64 mx-4 self-center bg-gray-900/50 text-white"}>
